...
addonObject = addon('plugin.video.utopia') # addonObject = addon('script.module.fenomscrapers')
...
#	try: settings_dict = jsloads(homeWindow.getProperty('fenomscrapers_settings'))
	try: settings_dict = jsloads(homeWindow.getProperty('Utopia_settings'))
...
#		homeWindow.setProperty('fenomscrapers_settings', jsdumps(settings_dict))
		homeWindow.setProperty('Utopia_settings', jsdumps(settings_dict))
